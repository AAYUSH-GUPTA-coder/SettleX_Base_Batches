...
// forge script script/Spoke/Base/Setter/SetUp/UpdateTrustedHubContracts.s.sol:UpdateTrustedHubContracts --account defaultKey --sender $WALLET_ADDRESS --rpc-url $BASE_SEPOLIA_RPC_URL --broadcast -vvv
