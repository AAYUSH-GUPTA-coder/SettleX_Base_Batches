...
// forge script script/Spoke/Zksync/Setter/SetUp/UpdateTrustedHubContracts.s.sol:UpdateTrustedHubContracts --account defaultKey --sender $WALLET_ADDRESS --rpc-url $ZKSYNC_SEPOLIA_RPC_URL --broadcast -vvv
