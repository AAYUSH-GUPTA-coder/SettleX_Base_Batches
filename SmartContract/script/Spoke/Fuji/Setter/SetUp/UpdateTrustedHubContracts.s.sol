...
// forge script script/Spoke/Fuji/Setter/SetUp/UpdateTrustedHubContracts.s.sol:UpdateTrustedHubContracts --account defaultKey --sender $WALLET_ADDRESS --rpc-url $FUJI_RPC_URL --broadcast -vvv
